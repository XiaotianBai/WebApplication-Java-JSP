...
<jsp:include page="../header.jsp"></jsp:include>
		...
		<div class="col-md-9 wow fadeInDown" data-wow-duration="0.5s">
			<div>
				...
				<ul class="nav nav-tabs" role="tablist">
			    	...
			    	<li role="presentation" class="active"><a href="#postInfoListPanel" aria-controls="postInfoListPanel" role="tab" data-toggle="tab">PostList</a></li>
				    		...
				    		<div class="row">
				    			<div class="col-md-12 top5">
				    				...
				    				<table class="table table-condensed table-hover">
				    					<tr class="success bold"><td>No.</td><td>Postid</td><td>PostTitle</td><td>Poster</td><td>Post Time</td><td>Views</td><td>Operations</td></tr>
				    					<% 
				    						/*Get StartIndex.*/
 										...
 										<tr>
 											...
 											<td>
 												...
 												<a href="#" onclick="postInfoDelete('<%=postInfo.getPostInfoId() %>');" style="display:none;"><i class="fa fa-trash-o fa-fw"></i>Delete</a>
 											</td> 
 										</tr>
 										<%}%>
				    				</table>
	...
	<div class="col-md-3 wow fadeInRight">
		...
		<form name="postInfoQueryForm" id="postInfoQueryForm" action="<%=basePath %>PostInfo/frontlist" class="mar_t15">
