...
<head>
  ...
  <TITLE>InspectPostDetails</TITLE>
...
<div class="container">
	<ul class="breadcrumb">
  		...
  		<li><a href="<%=basePath %>PostInfo/frontlist">PostInfo</a></li>
  		<li class="active">DetailsInspect</li>
	</ul>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">Postid:</div>
		<div class="col-md-10 col-xs-6"><%=postInfo.getPostInfoId()%></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">PostTitle:</div>
		<div class="col-md-10 col-xs-6"><%=postInfo.getPTitle()%></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">PostContent:</div>
	...
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">Post Time:</div>
		<div class="col-md-10 col-xs-6"><%=postInfo.getAddTime()%></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">Views:</div>
		...
		<div class="col-md-8 col-xs-7">
			...
			<div class="row" style="margin-top: 20px;">
				<div class="col-md-2 col-xs-3">
					<div class="row text-center"><img src="<%=basePath %><%=reply.getUserObj().getUserImage() %>" style="border: none;width:60px;height:60px;border-radius: 50%;" /></div>
	...
	<div class="row bottom15">
		...
		<div class="col-md-6 col-xs-6">
			<button onclick="userReply();" class="btn btn-primary">AddReply</button>
