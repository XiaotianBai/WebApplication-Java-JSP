    ...
    <td align="center"><table width="419" height="226" border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td align="center" background="<%=basePath %>images/error.jpg"><table width="388" height="194" border="0" cellpadding="0" cellspacing="0">
          <tr>
            <td align="center"><img src="<%=basePath %>images/error_b.gif" width="31" height="31">&nbsp;&nbsp;WarningInfo： <%=error%> <br>
              <br>
              <input name="Submit" type="submit" class="btn_grey" value="Return" onClick="history.back(-1)"></td>
          </tr>
        </table></td>
      </tr>
    </table></td>
