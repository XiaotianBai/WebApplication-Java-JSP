...
<jsp:include page="../header.jsp"></jsp:include>
		...
		<div class="col-md-9 wow fadeInDown" data-wow-duration="0.5s">
			<div>
				...
				<ul class="nav nav-tabs" role="tablist">
			    	...
			    	<li role="presentation" class="active"><a href="#productBiddingListPanel" aria-controls="productBiddingListPanel" role="tab" data-toggle="tab">BiddingList</a></li>
				    		...
				    		<div class="row">
				    			<div class="col-md-12 top5">
				    				...
				    				<table class="table table-condensed table-hover">
				    					<tr class="success bold"><td>No.</td><td>BiddingID</td><td>BiddingItem</td><td>BiddingUser</td><td>BiddingTime</td><td>BiddingPrice</td><td>Operations</td></tr>
				    					<% 
				    						/*Get StartIndex.*/
	...
	<div class="col-md-3 wow fadeInRight">
		...
		<form name="productBiddingQueryForm" id="productBiddingQueryForm" action="<%=basePath %>ProductBidding/frontlist" class="mar_t15">
