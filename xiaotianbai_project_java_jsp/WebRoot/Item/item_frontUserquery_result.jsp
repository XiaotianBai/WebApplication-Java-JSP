...
<jsp:include page="../header.jsp"></jsp:include>
	<div class="col-md-9 wow fadeInLeft">
		<ul class="breadcrumb">
  			...
  			<li><a href="<%=basePath %>Item/userFrontlist">Itemlist</a></li>
		...
		<div class="row">
			...
			<div class="col-md-3 bottom15" <%=clearLeft %>>
			  <a  href="<%=basePath  %>Item/<%=item.getItemId() %>/frontshow"><img class="img-responsive" src="<%=basePath%><%=item.getItemPhoto()%>" /></a>
			     <div class="showFields">
			        ...
			        <a class="btn btn-primary top5" onclick="itemDelete('<%=item.getItemId() %>');">Delete</a>
			     </div>
			</div>
			<%  } %>
			...
			<div class="row">
				<div class="col-md-12">
					...
					<div class="pull-right" style="line-height:75px;" >Records:<%=recordNumber %>Record，当前第 <%=currentPage %>/<%=totalPage %> 页</div>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="col-md-3 wow fadeInRight">
		...
		<form name="itemQueryForm" id="itemQueryForm" action="<%=basePath %>Item/userFrontlist" class="mar_t15">
