...
<table width='100%' cellspacing='1' cellpadding='3' bgcolor='#CCCCCC' class="tablewidth">
  ...
  <tr>
  	<td align="right" width="35%">以前的Password:</td>
    <td width=65%><input name="oldPassword" type=password /></td>   
  </tr>
 <tr>
  	<td align="right" width="35%">Input新Password:</td>
    <td width=65%><input name="newPassword" type=password /></td>   
  </tr>
  <tr>
  	<td align="right" width="35%">再Input新Password:</td>
