...
<jsp:include page="../header.jsp"></jsp:include>
		...
		<div class="col-md-9 wow fadeInDown" data-wow-duration="0.5s">
			<div>
				...
				<ul class="nav nav-tabs" role="tablist">
			    	...
			    	<li role="presentation" class="active"><a href="#userFollowListPanel" aria-controls="userFollowListPanel" role="tab" data-toggle="tab">UserFollowerList</a></li>
				    		...
				    		<div class="row">
				    			<div class="col-md-12 top5">
				    				...
				    				<table class="table table-condensed table-hover">
				    					<tr class="success bold"><td>No.</td><td>Recordid</td><td>Followed</td><td>Follower</td><td>FollowTime</td><td>Operations</td></tr>
				    					<% 
				    						/*Get StartIndex.*/
 										...
 										<tr>
 											...
 											<td>
 												...
 												<a href="#" onclick="userFollowDelete('<%=userFollow.getFollowId() %>');" style="display:none;"><i class="fa fa-trash-o fa-fw"></i>Delete</a>
 											</td> 
 										</tr>
 										<%}%>
				    				</table>
	...
	<div class="col-md-3 wow fadeInRight">
		...
		<form name="userFollowQueryForm" id="userFollowQueryForm" action="<%=basePath %>UserFollow/frontlist" class="mar_t15">
