...
<head>
  ...
  <TITLE>InspectUserFollowerDetails</TITLE>
...
<div class="container">
	<ul class="breadcrumb">
  		...
  		<li><a href="<%=basePath %>UserFollow/frontlist">UserFollowerInfo</a></li>
  		<li class="active">DetailsInspect</li>
	</ul>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">Recordid:</div>
		<div class="col-md-10 col-xs-6"><%=userFollow.getFollowId()%></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">Followed:</div>
		<div class="col-md-10 col-xs-6"><%=userFollow.getUserObj1().getName() %></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">Follower:</div>
		<div class="col-md-10 col-xs-6"><%=userFollow.getUserObj2().getName() %></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">FollowTime:</div>
